...
namespace Game.States
{
  public class StaticModelState : InterfaceGameState
  {
    ...
    public void Load()
    {
      ...
      _redRanger.Scale = new Vector3(5, 5, 5);
      _redRanger.Position = new Vector3(_terrain.Position.X + 200, _terrain.Position.Y + 130, _terrain.Position.Z);
      ...
      _yellowRanger.Scale = new Vector3(10, 10, 10);
      _yellowRanger.Position = new Vector3(_terrain.Position.X + 100, _terrain.Position.Y + 130, _terrain.Position.Z);
      ...
      _blackRanger.Scale = new Vector3(10, 10, 10);
      _blackRanger.Position = new Vector3(_terrain.Position.X + 0, _terrain.Position.Y + 130, _terrain.Position.Z);
      ...
      _blueRanger.Scale = new Vector3(10, 10, 10);
      _blueRanger.Position = new Vector3(_terrain.Position.X - 200, _terrain.Position.Y + 130, _terrain.Position.Z);
      ...
      _pinkRanger.Scale = new Vector3(10, 10, 10);
      _pinkRanger.Position = new Vector3(_terrain.Position.X - 100, _terrain.Position.Y + 130, _terrain.Position.Z);
      ...
      _RedRangerTwo.Scale = new Vector3(20, 20, 20);
      _RedRangerTwo.Position = new Vector3(_terrain.Position.X - 500, _terrain.Position.Y + 130, _terrain.Position.Z + 700);
