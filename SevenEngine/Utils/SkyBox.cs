...
namespace SevenEngine
{
  public class SkyBox
  {
    private static readonly int _vertexCount = 36;
    protected Vector3 _position;
    protected Vector3 _scale;
    protected Texture _top;
    protected Texture _bottom;
    ...
    /// <summary>The texture being applied to the bottom of the skybox.</summary>
    public Texture Bottom { get { return _bottom; } set { _bottom = value; } }
    ...
    public SkyBox()
    {
      ...
      _scale = new Vector3(100, 100, 100);
